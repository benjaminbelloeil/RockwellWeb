...
import { FaDiscord, FaGithub, FaGoogle, FaRegEnvelope, FaReg} from 'react-icons/fa';
      ...
      <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
        ...
        <div className="bg-white rounded-2xl shadow-2xl flex w-2/3 max-w-4xl">
          ...
          <div className="w-2/5 bg-red-600 text-white rounded-tr-2xl rounded-br-2xl py-40 px-12">
            ...
            <p className="mb-5">Enter your personal details and start your journey with us</p>
